...
if (!function_exists('bizway_options')) {
    ...
    function bizway_options() {
        ...
        $options_pages[''] = __('Select a page:', 'bizway');
        ...
        $options = array(
            array("name" => __("General Settings", 'bizway'),
                "type" => "heading"),
            array("name" => __("Custom Logo", 'bizway'),
            ...
            array("name" => __("Tracking Code", 'bizway'),
                ...
                "std" => "",
                "type" => "textarea"),
            array("name" => __("Front Page On/Off", 'bizway'),
                "desc" => __("If the front page option is active then home page will appear otherwise blog page will display.", 'bizway'),
                "id" => "re_nm",
                "std" => "on",
                "type" => "radio",
                "options" => $file_rename),
            ...
            array("name" => __("Slide 1 Link", 'bizway'),
                "desc" => __("Enter your link url for slide1", 'bizway'),
...
//****=============================================================================****//				
            ...
            array("name" => __("Custom CSS", 'bizway'),
                ...
                "std" => "",
                "type" => "textarea"));
        return apply_filters('bizway_option_defaults', array('of_template' => $options, 'theme_name' => $themename));
    }
