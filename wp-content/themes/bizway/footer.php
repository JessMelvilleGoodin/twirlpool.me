        ...
        <div class="container_24">
            <div class="grid_24">
                <div class="footer_bottom_content">
                    ...
                    <?php } else { ?>
                        <p class="copyright"> <a href="<?php esc_url("http://www.inkthemes.com"); ?>"><?php _e('BizWay Theme', 'bizway'); ?></a><?php _e(' powered by ', 'bizway'); ?><a href="http://www.wordpress.org"><?php _e('WordPress', 'bizway'); ?></a></p>
                            <?php } ?>
                </div>
            </div>
        </div>
