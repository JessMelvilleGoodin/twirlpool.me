            ...
            <div class="row">
                <div class="col-md-12">
                   ...
                   <div id="divLogo" class="pull-left">
                     <?php    if($options['logo'] != '') { echo '<img src="'.esc_url_raw($options['logo']).'">'; }else{ echo ' <a href="http://twirlpool.me" id="divSiteTitle">'; echo bloginfo('name'); echo '</a><br />
                        <a href="http://twirlpool.me" id="divTagLine">';echo bloginfo('description'); echo'</a>'; } ?>
                    </div>
